...
function Home() {
  ...
  return (
    <div className="wrapper">
      ...
      <Header title="Movies" nav={pages.map((i, index) => <Pagination key={index} onClick={() => dispatch(setCurrentPage(i))} className={i === currentPage ? 'nav__link active' : 'nav__link'}>{i}</Pagination>)}/>
      {isFetching ?
      ...
      <div className="main">
        <div className="container">
          <div className="cart">
            ...
            {movies && movies.map((item, index) => <CartItem key={index}  movies={item} />
            )}
